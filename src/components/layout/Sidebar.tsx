      ...
      <div className="p-4 border-t border-mr-border">
        <div className="flex items-center gap-3 px-2">
          <div className="w-8 h-8 bg-mr-secondary flex items-center justify-center">
            <span className="text-mr-text font-semibold text-sm">OP</span>
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-mr-text truncate">Operador</p>
            <p className="text-xs text-mr-text/50 uppercase">Mecánico</p>
          </div>
        </div>
      </div>
    </aside>

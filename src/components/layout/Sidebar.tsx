    ...
    <aside className="w-64 min-h-screen bg-mr-bg border-r border-mr-border flex flex-col">
      ...
      <div className="h-16 flex items-center px-6 border-b border-mr-border">
        <Link href="/dashboard" className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-mr-accent tracking-wider leading-none">MR1</h1>
            <p className="text-[10px] text-mr-text/60 uppercase tracking-widest leading-none mt-1">MecaRapid</p>
          </div>
        </Link>
      </div>
